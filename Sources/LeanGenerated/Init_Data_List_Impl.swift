...
@inline(__always) public func List_replaceTR<A: Equatable>(_ l: List<A>, _ b: A, _ c: A) -> List<A> {
  l.replaceTR(b, c)
}
...
public func List_setTR_go<A>(_ l: List<A>, _ a: A, _ x_1: List<A>, _ x_2: Nat, _ x_3: Array<A>) -> List<A> {
  ...
  case .cons(let head_8, let tail_9):
    if x_2 == 0 {
      let _x_10: List<A> = List<A>.cons(a, tail_9)
      let _x_11 = Array_size(x_3)
      let _x_12: Nat = 0
      let _x_14 = _x_12 < _x_11
      if _x_14 {
        let _x_17 = USize_ofNat(_x_11)
        let _x_18: UInt = 0
      ...
      let n_20: Nat = x_2 - 1
      let _x_21 = Array_push(x_3, head_8)
...
public func List_replaceTR_go<A: Equatable>(_ l: List<A>, _ b: A, _ c: A, _ x_2: List<A>, _ x_3: Array<A>) -> List<A> {
  ...
  case .cons(let head_8, let tail_9):
    let _x_11 = b == head_8
    if _x_11 {
      let _x_14: List<A> = List<A>.cons(c, tail_9)
      let _x_15 = Array_size(x_3)
      let _x_16: Nat = 0
      let _x_18 = _x_16 < _x_15
      if _x_18 {
        let _x_21 = USize_ofNat(_x_15)
        let _x_22: UInt = 0
      ...
      let _x_12 = Array_push(x_3, head_8)
...
@inline(__always) public func List_eraseTR<A: Equatable>(_ l: List<A>, _ a: A) -> List<A> {
  l.eraseTR(a)
}
...
public func List_intercalateTR_go<A>(_ sep: Array<A>, _ x_1: List<A>, _ x_2: List<List<A>>, _ x_3: Array<A>) -> List<A> {
  ...
  switch x_2 {
  case .`nil`:
    let _x_8 = Array_size(x_3)
    let _x_9: Nat = 0
    let _x_11 = _x_9 < _x_8
    if _x_11 {
      let _x_14 = USize_ofNat(_x_8)
      let _x_15: UInt = 0
  ...
  case .cons(let head_17, let tail_18):
    let _x_19 = Array_appendList(x_3, x_1)
    let _x_20 = Array_append(_x_19, sep)
...
public func List_erasePTR_go<A>(_ p: @escaping (A) -> Bool, _ l: List<A>, _ x_1: List<A>, _ x_2: Array<A>) -> List<A> {
  ...
  case .cons(let head_7, let tail_8):
    let _x_9 = p(head_7)
    if _x_9 {
      let _x_12 = Array_size(x_2)
      let _x_13: Nat = 0
      let _x_15 = _x_13 < _x_12
      if _x_15 {
        let _x_18 = USize_ofNat(_x_12)
        let _x_19: UInt = 0
      ...
      let _x_10 = Array_push(x_2, head_7)
...
public func List_eraseIdxTR_go<A>(_ l: List<A>, _ x_1: List<A>, _ x_2: Nat, _ x_3: Array<A>) -> List<A> {
  ...
  case .cons(let head_8, let tail_9):
    if x_2 == 0 {
      let _x_10 = Array_size(x_3)
      let _x_11: Nat = 0
      let _x_13 = _x_11 < _x_10
      if _x_13 {
        let _x_16 = USize_ofNat(_x_10)
        let _x_17: UInt = 0
      ...
      let n_19: Nat = x_2 - 1
      let _x_20 = Array_push(x_3, head_8)
...
public func List_eraseTR_go<A: Equatable>(_ l: List<A>, _ a: A, _ x_2: List<A>, _ x_3: Array<A>) -> List<A> {
  ...
  case .cons(let head_8, let tail_9):
    let _x_11 = head_8 == a
    if _x_11 {
      let _x_14 = Array_size(x_3)
      let _x_15: Nat = 0
      let _x_17 = _x_15 < _x_14
      if _x_17 {
        let _x_20 = USize_ofNat(_x_14)
        let _x_21: UInt = 0
