...
public extension List where A: Equatable {
  func instDecidableSublistOfDecidableEq_src(_ inst_1: @escaping (A, A) -> Decidable, _ `l₂`: List<A>) -> Decidable {
    let _x_3 = List_isSublist(self, `l₂`)
    if _x_3 {
...
@inline(__always) public func List_instDecidableSublistOfDecidableEq_src<A: Equatable>(_ inst_1: @escaping (A, A) -> Decidable, _ `l₁`: List<A>, _ `l₂`: List<A>) -> Decidable {
...
public extension List where A: Equatable {
  func instDecidableIsSuffixOfDecidableEq_src(_ inst_1: @escaping (A, A) -> Decidable, _ `l₂`: List<A>) -> Decidable {
    let _x_3 = List_isSuffixOf(self, `l₂`)
    if _x_3 {
      return Decidable.isTrue
    } else {
      return Decidable.isFalse
...
@inline(__always) public func List_instDecidableIsSuffixOfDecidableEq_src<A: Equatable>(_ inst_1: @escaping (A, A) -> Decidable, _ `l₁`: List<A>, _ `l₂`: List<A>) -> Decidable {
...
public extension List where A: Equatable {
  func instDecidableIsPrefixOfDecidableEq_src(_ inst_1: @escaping (A, A) -> Decidable, _ `l₂`: List<A>) -> Decidable {
    let _x_3 = List_isPrefixOf(self, `l₂`)
    if _x_3 {
      return Decidable.isTrue
    } else {
      return Decidable.isFalse
...
@inline(__always) public func List_instDecidableIsPrefixOfDecidableEq_src<A: Equatable>(_ inst_1: @escaping (A, A) -> Decidable, _ `l₁`: List<A>, _ `l₂`: List<A>) -> Decidable {
